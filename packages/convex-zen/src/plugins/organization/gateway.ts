...
export const updateOrganization = pluginMutation({
	...
	handler: async (
		...
		await updateOrganizationByMember(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
				rolePermissions,
				name,
				slug,
				logo,
...
export const deleteOrganization = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, organizationId, rolePermissions },
	) =>
		await deleteOrganizationByMember(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
...
export const listMembers = pluginQuery({
	...
	handler: async (
		...
		await listOrganizationMembersByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
				...
				role:
					role.type === "system"
						...
						: {
								...
								customRoleId: role.customRoleId as Id<"organization__roles">,
							},
				accessControl,
				inviteExpiresInMs,
				rolePermissions,
...
export const listInvitations = pluginQuery({
	...
	handler: async (
		...
		await listOrganizationInvitationsByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
...
export const listIncomingInvitations = pluginQuery({
	...
	handler: async (ctx: QueryCtx, { actorUserId, actorEmail }) =>
		await listIncomingOrganizationInvitationsForUser(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				actorEmail,
...
export const acceptInvitation = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, actorEmail, token, rolePermissions },
	) =>
...
export const acceptIncomingInvitation = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, actorEmail, invitationId },
	) =>
		await acceptIncomingOrganizationInvitation(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				actorEmail,
				invitationId: invitationId as Id<"organization__invitations">,
			}),
		),
});
...
export const cancelInvitation = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, invitationId, rolePermissions },
	) =>
...
export const declineIncomingInvitation = pluginMutation({
	...
	handler: async (
		...
		await declineIncomingOrganizationInvitation(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				actorEmail,
...
export const removeMember = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, organizationId, userId, rolePermissions },
	) =>
...
export const setMemberRole = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, organizationId, userId, role, rolePermissions },
	) =>
...
export const listRoles = pluginQuery({
	...
	handler: async (
		...
		roles: await listOrganizationRolesByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
...
export const listAvailablePermissions = pluginQuery({
	...
	handler: async (
		...
		await listAvailableOrganizationPermissionsByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
...
export const getRole = pluginQuery({
	...
	handler: async (ctx: QueryCtx, { actorUserId, roleId, rolePermissions }) =>
		await getOrganizationRoleByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				roleId: roleId as Id<"organization__roles">,
				rolePermissions,
			}),
		),
});
...
export const addDomain = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, organizationId, hostname, rolePermissions },
	) =>
...
export const listDomains = pluginQuery({
	...
	handler: async (
		...
		await listOrganizationDomainsByActor(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				organizationId: organizationId as Id<"organization__organizations">,
...
export const getDomainVerificationChallenge = pluginQuery({
	...
	handler: async (ctx: QueryCtx, { actorUserId, domainId, rolePermissions }) =>
		await getOrganizationDomainVerificationChallenge(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				domainId: domainId as Id<"organization__domains">,
				rolePermissions,
			}),
		),
});
...
export const markDomainVerified = pluginMutation({
	...
	handler: async (
		ctx: MutationCtx,
		{ actorUserId, domainId, rolePermissions },
	) =>
		await markOrganizationDomainVerified(
			ctx.db,
			omitUndefined({
				actorUserId: actorUserId as Id<"users">,
				domainId: domainId as Id<"organization__domains">,
...
export const hasRole = pluginQuery({
	...
	handler: async (
		ctx: QueryCtx,
		{ actorUserId, organizationId, role, roles },
	) =>
...
export const hasPermission = pluginQuery({
	...
	handler: async (
		ctx: QueryCtx,
		{ actorUserId, organizationId, permission, rolePermissions },
	) =>
